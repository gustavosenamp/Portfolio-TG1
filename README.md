...
- **Eclipse**: Ambiente de desenvolvimento integrado (**IDE**) usado para programar e gerenciar o projeto em Java.

- **GRADLE**: Ferramenta de automação utilizada para compilação, gerenciamento de dependências e build do projeto.

- **MYSQL**: Banco de dados utilizado para armazenar informações dos documentos e interações dos usuários.

- **FIGMA**: Utilizado na criação dos protótipos da interface do chatbot.

- **Trello**: Ferramenta de gerenciamento de tarefas e organização do fluxo de trabalho da equipe.

- **Microsoft Office**: Utilizado para documentação, planejamento e relatórios do projeto.
...
- **Eclipse**: IDE utilizada para o desenvolvimento e depuração do código. **Nível de proficiência:** Uso com autonomia

- **GRADLE**: Ferramenta de build e gerenciamento de dependências. **Nível de proficiência:** Faço com ajuda

- **MYSQL**: Banco de dados utilizado para armazenar informações e interações. **Nível de proficiência:** Uso com autonomia

- **Trello**: Organização de tarefas e acompanhamento do desenvolvimento. **Nível de proficiência:** Uso com autonomia

- **Microsoft Office**: Documentação, relatórios e apresentações. **Nível de proficiência:** Consigo ensinar
...
- **TypeScript**: Utilizado para garantir tipagem estática no front-end, promovendo maior segurança e legibilidade no código.

- **JavaScript**: Linguagem base para manipulação de lógica e integração da interface com os dados.

- **Node.js**: Plataforma para construção do backend da aplicação, responsável pelo upload, processamento e envio de dados.

- **MySQL**: Banco de dados relacional utilizado para armazenar e organizar os dados das planilhas.

- **Figma**: Utilizado para prototipação e definição visual das telas do sistema, com foco em usabilidade e estética.

- **GitHub**: Ferramenta de versionamento utilizada para controle do código-fonte e colaboração entre os membros da equipe.

- **Trello**: Gerenciador de tarefas e organização do projeto, utilizado para planejar entregas e acompanhar o progresso.
...
- **TypeScript**: Tipagem segura dos componentes front-end. **Nível de proficiência:** Uso com autonomia

- **JavaScript**: Manipulação de dados e lógicas de interface. **Nível de proficiência:** Uso com autonomia

- **Node.js**: Integração com API e backend. **Nível de proficiência:** Uso com autonomia

- **MySQL**: Modelagem e execução de consultas no banco de dados. **Nível de proficiência:** Uso com autonomia

- **GitHub**: Controle de versão e colaboração em equipe. **Nível de proficiência:** Consigo ensinar
...
* **Trabalho em Equipe:** Colaborei com desenvolvedores, designers e stakeholders para integrar os dados do Excel ao dashboard, assegurando a consistência entre front-end, back-end e as necessidades da Pro4Tech.

* **Comunicação Eficaz:** Mediava discussões técnicas e funcionais no Slack e em reuniões, promovendo clareza nas decisões e resolução de bloqueios de forma ágil.

* **Gestão de Tempo:** Gerenciei prazos e prioridades do projeto, equilibrando minhas responsabilidades como Scrum Master com as entregas técnicas, mantendo o cronograma das sprints.
